...
const futbol = document.querySelector(".futbol_container");
const baloncesto = document.querySelector(".baloncesto_container");
const natacion = document.querySelector(".natacion_container");
const padel = document.querySelector(".padel_container");
const atletismo = document.querySelector(".atletismo_container");
...
document.addEventListener('DOMContentLoaded', function() {
    menuBtn.addEventListener('click', function() {
        if (baloncesto.style.display === 'none') {
            baloncesto.style.display = 'block';
        } else {
            baloncesto.style.display = 'none';
        }
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    menuBtn.addEventListener('click', function() {
        if (natacion.style.display === 'none') {
            natacion.style.display = 'block';
        } else {
            natacion.style.display = 'none';
        }
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    // Add a click event listener to the menu button
    menuBtn.addEventListener('click', function() {
        if (atletismo.style.display === 'none') {
            atletismo.style.display = 'block';
        } else {
            atletismo.style.display = 'none';
        }
    });
});
